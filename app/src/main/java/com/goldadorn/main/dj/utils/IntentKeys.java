...
public class IntentKeys {
    ...
    public static final String FILTER_POST_PARAMS = "goldadorn.filter_post_params";
    //public static final String DESIGNER_DETAILS = "goldadorn.designer";
    ...
    public static final String PRODUCT_DETAILS_NAME = "goldadorn.product.name";*/
}

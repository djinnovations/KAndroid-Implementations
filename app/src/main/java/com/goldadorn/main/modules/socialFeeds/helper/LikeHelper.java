 ...
 */
public class LikeHelper extends PostUpdateHelper
{
    public LikeHelper(Activity activity,List<Cookie> cookies,PostUpdateResult postUpdateResult)
    {
    ...
    {
        return URLHelper.getInstance().getLikeAPostServiceURL();
    }

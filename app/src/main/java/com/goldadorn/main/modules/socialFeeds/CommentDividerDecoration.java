...
public class CommentDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public CommentDividerDecoration(Context context) {
        this(context, VERTICAL);
    }


    public CommentDividerDecoration(Context context, int orientation) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        if (mOrientation == VERTICAL) {
            outRect.set(0, mInsets, mInsets, mDivider.getIntrinsicHeight());
        } else {

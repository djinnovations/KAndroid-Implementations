...
public class ProductCustomInfo implements Serializable {
    public final int id;
    public String code;
    ...
    public ProductCustomInfo(int id) {
        this.id = id;
    }


    public static ProductCustomInfo extractFromJson(JSONObject obj) throws JSONException {
        ProductCustomInfo p = new ProductCustomInfo(obj.getInt(Constants.JsonConstants.PRODUCT_ID));

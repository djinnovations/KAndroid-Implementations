package com.goldadorn.main.intro;
...
class DefaultIndicatorController implements IndicatorController {
    ...
    public void initialize(int slideCount) {
        ...
        for (int i = 0; i < slideCount; i++) {
            ...
            dot.setImageDrawable(ContextCompat.getDrawable(mContext, com.github.paolorotolo.appintro.R.drawable.indicator_dot_grey));
    ...
    public void selectPosition(int index) {
        ...
        for (int i = 0; i < mSlideCount; i++) {
            int drawableId = (i == index) ? (com.github.paolorotolo.appintro.R.drawable.indicator_dot_white) : (com.github.paolorotolo.appintro.R.drawable.indicator_dot_grey);

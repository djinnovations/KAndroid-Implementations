 ...
 */
public class TypeHelper implements IViewProvider,DefaultProjectDataManager.IDataManagerDelegate {
    private final RecyclerView recyclerView;
    public TypeHelper(BaseActivity activity, RecyclerView recyclerView, RecyclerViewHelper.OnItemClick selector)
    {
    ...
    public String getNextDataURL(PageData pageData) {
        String url=URLHelper.getInstance().getProductType(offset);
        return url;
    }
    @Override
    ...
    public static class Result extends CodeDataParser
    {
        ...
        public void setData(List<FilterType> data){this.prodTypeList=data;}
    ...
    {
        View view =inflater.inflate(R.layout.filter_type_item,container,false);
    ...
    public static class BindingItemHolder<T extends FilterTypeItemBinding> extends BindingRecycleItemHolder<T>
    {

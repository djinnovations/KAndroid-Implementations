...
import com.goldadorn.main.databinding.FilterCollectionItemBinding;
 ...
 */
public class CollectionHelper implements IViewProvider,DefaultProjectDataManager.IDataManagerDelegate {
    private final RecyclerView recyclerView;
    public CollectionHelper(BaseActivity activity, RecyclerView recyclerView, RecyclerViewHelper.OnItemClick selector)
    {
    ...
    public String getNextDataURL(PageData pageData) {
        String url=URLHelper.getInstance().getCollectionData(offset);
        return url;
    }
    @Override
    ...
    {
        List<FilterCollection> collectionList;
        ...
        public List<FilterCollection> getData()
        {
            return collectionList;
        }
        public void setData(List<FilterCollection> data){this.collectionList=data;}
    ...
    {
        View view =inflater.inflate(R.layout.filter_collection_item,container,false);
    ...
    public static class BindingItemHolder<T extends FilterCollectionItemBinding> extends BindingRecycleItemHolder<T>
    {

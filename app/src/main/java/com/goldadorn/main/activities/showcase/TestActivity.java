...
public class TestActivity extends Activity {
    ...
    */
    ...
    private String mSuccessUrl = "test://succ";
    private String mFailedUrl = "test://fail";
...
//                        startActivity(intent);
            ...
            webView.addJavascriptInterface(new PayUJavaScriptInterface(TestActivity.this), "PayUMoney");
    ...
    public class PayUJavaScriptInterface {
        ...
        public void success(long id, final String paymentId) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    mHandler = null;
                    Toast.makeText(TestActivity.this, "Payment Successfully.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }

...
public class AdapterLayoutDelegate {
    ...
    public @Nullable RecyclerView.ViewHolder getViewHolderAt(int index) {
        ...
        return (RecyclerView.ViewHolder) view.getTag(R.id.kimeeo_adapter_layout_list_holder);
    }
    ...
    private void addViewAt(int viewType, int index) {
        ...
        viewHolder.itemView.setTag(R.id.kimeeo_adapter_layout_list_holder, viewHolder);
        viewHolder.itemView.setTag(R.id.kimeeo_adapter_layout_list_view_type, viewType);
        ...
        for (int i = 0; i < mAdapter.getItemCount() || i < mViewGroup.getChildCount(); i++) {
            ...
            if (i < mAdapter.getItemCount()) {
                ...
                if (i < mViewGroup.getChildCount()) {
                    ...
                    Integer savedViewType = (Integer) child.getTag(R.id.kimeeo_adapter_layout_list_view_type);
                    RecyclerView.ViewHolder savedViewHolder = (RecyclerView.ViewHolder) child.getTag(R.id.kimeeo_adapter_layout_list_holder);
